                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            {{ __('transaction.my_outgoing_trans') }}
                                        ...
                                        @foreach ($transactions as $transaction)
                                            ...
                                            <tr id="{{ $transaction->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('transaction/connected',[$transaction->id])}}" class="btn btn-outline-info btn-sm">
                            ...
                            <div class="col-md-12">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="{{ $transactions->nextPageUrl() }}">{{ __('homePage.next') }}</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
