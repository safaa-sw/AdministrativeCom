                ...
                <div class="col-sm-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="transTable"
                                class="table table-bordered table-striped {{ count($secrets) > 0 ? 'datatable' : '' }} dt-select">
                                <thead>
                                    <tr>
                                        <th>م</th>
                                    ...
                                    @if (count($secrets) > 0)
                                        ...
                                        @foreach ($secrets as $secret)
                                            ...
                                            <tr id="{{ $secret->id }}">
                                                ...
                                                <td>{{ $count }}</td>
                                                <td class="row-data">{{ $secret->name }}</td>
                            ...
                            <div class="col-md-12">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $secrets->previousPageUrl() }}"
                                                tabindex="-1">{{__('homePage.previous')}}</a>
                                        </li>
                                        <li class="page-item disabled"></li>
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $secrets->nextPageUrl() }}">{{__('homePage.next')}}</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('secrets.update')}}">
                        @csrf
                        <div class="form-group row">
                            <div class="col-md-8">
                                <input id="secretId" type="hidden" class="form-control" name="secretId"
                                                    value="">
