                ...
                <div class="col-sm-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="depatrmentTable"
                                class="table table-bordered table-striped {{ count($departments) > 0 ? 'datatable' : '' }} dt-select">
                                <thead>
                                    <tr>
                                        <th>م</th>
                                    ...
                                    @if (count($departments) > 0)
                                        ...
                                        @foreach ($departments as $department)
                                            ...
                                            <tr id="{{ $department->id }}">
                                                ...
                                                <td>{{ $count }}</td>
                                                <td class="row-data">{{ $department->name }}</td>
                            ...
                            <div class="col-md-12">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $departments->nextPageUrl() }}">{{__('homePage.next')}}</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-8">
                                <label for="roleShow" class="col-md-5 col-form-label text-md-right">
                                    {{ __('homePage.department') }}
                                </label>
                                <input class="form-control" type="text" id="departmentShow" name="departmentShow" disabled>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('department.update')}}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-8">
                                <input id="departmentId" type="hidden" class="form-control" name="departmentId"
                                                    value="">
                                <label for="departmentEdit" class="col-md-5 col-form-label text-md-right">
                                    {{ __('homePage.department') }}
                                </label>
                                <input id="departmentEdit" type="text" class="form-control" name="departmentEdit"
                                                    value="" autofocus required>
                            </div>
                        </div>
...
<script>
    function showBtnClick() {
        ...
        $("#departmentShow").val(data[0].innerHTML);
    }
    function editBtnClick() {
        var rowId=event.target.parentNode.parentNode.id;
        var data=document.getElementById(rowId).querySelectorAll(".row-data");
        $("#departmentId").val(rowId);
        $("#departmentEdit").val(data[0].innerHTML);
